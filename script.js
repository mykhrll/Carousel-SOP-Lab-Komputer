...
// Click Sound (Local sound_effect_click.wav)
const clickAudio = new Audio('sounds/sound_effect_click.wav');
clickAudio.volume = 0.8; // Set volume to 80%

function playClickSound() {
  // Clone node allows overlapping sounds if clicked very quickly
  const sound = clickAudio.cloneNode();
  sound.volume = clickAudio.volume;
  sound.play().catch(e => console.log('Click sound autoplay prevented:', e));
}
...
// Attach click sound to any click on the document
document.addEventListener('click', (e) => {
  // Don't play default click sound for music toggle (it has its own handler with stopPropagation)
